...
| **2 · Clean matched contrast** | One focal trait changes between arms, strong time overlap, visual or copy held constant | Strong directional quasi-experimental evidence | Prioritize for a controlled test |
...
> within-set CTR difference of +18%, favorable in 7 of 9. Variants were not randomly assigned and
> 5 of 9 changed other copy traits alongside the CTA. Treat as directional corroboration and
> prioritize for a controlled test.
...
targeting, bid strategy, budget or optimization state. The contrast is strong evidence that *the
...
targeting, budget, bid strategy and optimization state. The generalization gate — 3+ segments, no
...
- **Give an interval**, even a descriptive bootstrap one, clearly labeled as descriptive when n is
  tiny.
...
Every normalized metric depends on a benchmark. If an ad's own performance contributed to the
...
evidence       9 matched sets · 7 favorable · median within-set +18%
